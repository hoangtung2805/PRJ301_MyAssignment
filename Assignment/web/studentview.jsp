<%-- 
    ...
    Created on : Oct 12, 2022, 10:00:44 AM
    Author     : PC
--%>
  ...
  <body>
    <div class="container">
      ...
      <div class="home-header">
        <a href="https://fap.fpt.edu.vn/Default.aspx">Home</a>
        &nbsp;|&nbsp;
        <b>View Schedule</b>
      </div>
      ...
      <table>
        <tbody>
          <h1><span>Activities for TungPHHE140145 (Phan Hoàng Tùng)</span></h1>
          <p>
        ...
        <table border="1px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center">
                <p>
                  <a style="color: blue">PRJ301</a><br />
                  "at DE-416" <br />
                  <a style="color: green">attended</a><br />
                  (9:10-10:40)
                </p>
              </td>
              <td align="center">-</td>
        ...
        <p><b>More note / Chú ý thêm:</b></p>
        <p>
          (<a style="color: green">attended</a>): Student had attended this
          activity / Sinh viên đã tham gia hoạt động này
        </p>

        <p>
          (<a style="color: red">absent</a>): Student had NOT attended this
          activity / Sinh viên đã vắng mặt buổi này
        </p>
